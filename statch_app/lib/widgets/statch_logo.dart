...
class _StatchLogoPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(covariant _StatchLogoPainter oldDelegate) {
...
/// Animated Statch Logo with pulse and glow effect
...
/// Statch Logo with draw animation
...
class _DrawAnimatedLogoPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Draw the chart line with progress
    if (progress > 0.1) {
